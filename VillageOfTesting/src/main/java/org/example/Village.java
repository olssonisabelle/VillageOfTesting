...
public class Village {
    ...
    //Lade till en if-sats för att maxWorker skulle kontrolleras mot worker.size.
     public boolean AddWorker(String name, String occupation) {
         if (workers.size() >= maxWorkers) {
             System.out.println("Village is full.");
             return false;
         }
    ...
    // Ändrade till boolean för att kunna göra en assertTrue för att säkerställa att projektet adderats.
